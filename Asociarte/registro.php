...
<html lang="en">
  <head>
    ...
    <title>Registro Asociarce</title>
  </head>
  <body>
       <?php include 'navbar.php'?>
   <section class="contact-box">
       <div class="row no-gutters bg-dark">
           <div class="col-xl-5 col-lg-12 register-bg bg-img">
            <div class="position-absolute testiomonial p-4">
                <h3 class="font-weight-bold text-light">Conoce Asociarce</h3>
                <p class="lead text-light">Accede a la tienda virtual y a mucho más</p>
            </div>
           </div>
           <div class="col-xl-7 col-lg-12 d-flex">
                <div class="container align-self-center p-6">
                    <h1 class="font-weight-bold mb-3">Registrar un nuevo usuario</h1>
                    ...
                    <form>
                        ...
                        <button class="btn btn-primary width-100">Regístrar</button>
                    </form>
                    <small class="d-inline-block text-muted mt-5">Todos los derechos reservados | © 2023</small>
                </div>
           </div>
       </div>
   </section>
